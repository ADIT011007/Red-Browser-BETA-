This a Basic web browser with some issues which will be latter be fixed on request . I do not guarantee that this project will be in devlopment for long time and is stable.
